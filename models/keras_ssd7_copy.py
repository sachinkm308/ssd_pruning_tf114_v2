...
##Adding below lines for pruning
...
def build_model(image_size,
    ...
    '''
    print("Reporting from ssd7 copy file")
    ...
    anchors4 = keras.layers.AnchorBoxes(img_height, img_width, this_scale=scales[0], next_scale=scales[1], aspect_ratios=aspect_ratios[0],
    ...
    anchors5 = keras.layers.AnchorBoxes(img_height, img_width, this_scale=scales[1], next_scale=scales[2], aspect_ratios=aspect_ratios[1],
    ...
    anchors6 = keras.layers.AnchorBoxes(img_height, img_width, this_scale=scales[2], next_scale=scales[3], aspect_ratios=aspect_ratios[2],
    ...
    anchors7 = keras.layers.AnchorBoxes(img_height, img_width, this_scale=scales[3], next_scale=scales[4], aspect_ratios=aspect_ratios[3],
